...
//     return(
//         <>
//         <button className="random-btn" onClick={myfun}>surprise me </button>
//         {k!==null && (<><br /><br />
//             <span>Id : {arr[k].id}</span><br />
//             <span className="author">author's name : </span> <span>{arr[k].name}</span><br />
//             <span className="job">job : </span> <span>{arr[k].job}</span><br />
//             <span className="info">review text : </span> <span>{arr[k].text}</span><br />
//             <img width='200' height='200'
//              src={arr[k].image} alt="Error..." /></>)}
//             </>
//     )
// }
